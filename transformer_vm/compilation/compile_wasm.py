...
Usage:
    python -m transformer_vm.compilation.compile_wasm examples/hello.c
    python -m transformer_vm.compilation.compile_wasm examples/collatz.c --args 7
    python -m transformer_vm.compilation.compile_wasm examples/hello.wasm -o data/hello
...
def load_manifest():
    ...
    from transformer_vm._paths import MANIFEST
